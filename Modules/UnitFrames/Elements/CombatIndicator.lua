...
local CombatTextures = {
	...
	["COMBAT"] = [[Interface\AddOns\OctoUI\media\textures\combat]],
	["ATTACK"] = [[Interface\CURSOR\Attack]],
	["ALERT"] = [[Interface\AddOns\OctoUI\media\textures\UI-Dialog-Icon-AlertNew]],
	["ALERT2"] = [[Interface\AddOns\OctoUI\media\textures\UI-OptionsFrame-NewFeatureIcon]],
	["ARTHAS"] = [[Interface\AddOns\OctoUI\media\textures\UI-LFR-PORTRAIT]],
