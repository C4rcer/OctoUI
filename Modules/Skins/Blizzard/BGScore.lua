...
local function LoadSkin()
	...
	for i = 1, 3 do
		...
		local skinObj = _G["WorldStateScoreFrameTab"..i.."Text"]
		if skinObj then skinObj:SetPoint("CENTER", 0, 2) end
	end
	...
	--[[hooksecurefunc("WorldStateScoreFrame_Update", function()
		...
		for i = 1, MAX_WORLDSTATE_SCORE_BUTTONS do
			...
			if name then
				...
				local skinObj = _G["WorldStateScoreButton"..i.."NameText"]
				if skinObj then skinObj:SetText(n) end
				local skinObj = _G["WorldStateScoreButton"..i.."NameText"]
