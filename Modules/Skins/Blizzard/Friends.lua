...
local function LoadSkin()
	...
	for i = 1, 17 do
		...
		button.icon:SetTexture("Interface\\AddOns\\OctoUI\\Media\\Textures\\Icons-Classes")
		...
		local skinObj = _G["WhoFrameButton"..i.."Class"]
		if skinObj then skinObj:Hide() end
	end
	...
	for i = 1, GUILDMEMBERS_TO_DISPLAY do
		...
		local skinObj = _G["GuildFrameButton"..i.."Class"]
		if skinObj then skinObj:Hide() end
		...
		if FriendsFrame.playerStatusFrame then
			...
			for i = 1, GUILDMEMBERS_TO_DISPLAY, 1 do
				...
				if classFileName then
					if online then
						classTextColor = CUSTOM_CLASS_COLORS and CUSTOM_CLASS_COLORS[classFileName] or RAID_CLASS_COLORS[classFileName]
						local skinObj = _G["GuildFrameGuildStatusButton"..i.."Name"]
						if skinObj then skinObj:SetTextColor(classTextColor.r, classTextColor.g, classTextColor.b) end
						local skinObj = _G["GuildFrameGuildStatusButton"..i.."Online"]
						if skinObj then skinObj:SetTextColor(1.0, 1.0, 1.0) end
					end
				end
			end
		end
	...
	local function SkinPlusMinus(button, minus)
		...
		button:SetPushedTexture("Interface\\AddOns\\OctoUI\\media\\textures\\PlusMinusButton")
		button.SetPushedTexture = E.noop

		button:SetHighlightTexture("")
		button.SetHighlightTexture = E.noop

		button:SetDisabledTexture("Interface\\AddOns\\OctoUI\\media\\textures\\PlusMinusButton")
