...
local function LoadSkin()
	...
	hooksecurefunc("QuestRewardItem_OnClick", function()
		...
		local skinObj = _G[this:GetName().."Name"]
		if skinObj then skinObj:SetTextColor(1, 1, 0) end
	...
	hooksecurefunc("QuestFrameItems_Update", function(questState)
		...
		--QuestInfoRequiredMoneyText does not exist on this client
		if QuestInfoRequiredMoneyText and GetQuestLogRequiredMoney() > 0 then
	...
	for i = 1, QUESTS_DISPLAYED do
		...
		questLogTitle:SetNormalTexture("Interface\\AddOns\\OctoUI\\media\\textures\\PlusMinusButton")
	...
	QuestLogCollapseAllButton:SetNormalTexture("Interface\\AddOns\\OctoUI\\media\\textures\\PlusMinusButton")
	...
	QuestLogCollapseAllButton:SetDisabledTexture("Interface\\AddOns\\OctoUI\\media\\textures\\PlusMinusButton")
