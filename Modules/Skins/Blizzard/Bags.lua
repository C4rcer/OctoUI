...
local function LoadSkin()
	...
	for i = 1, NUM_BANKBAGSLOTS, 1 do
		...
		local bagHighlight = _G["BankFrameBag"..i.."HighlightFrameTexture"]
		if bagHighlight then
			E:SetInside(bagHighlight)
			if bagHighlight.SetTexture then
				bagHighlight:SetTexture(unpack(E["media"].rgbvaluecolor), 0.3)
			end
		end
	end
