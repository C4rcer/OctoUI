		...
		if pullout and pullout.frame then
			...
			if not pullout.slider.template then
				...
				if pullout.slider:GetThumbTexture() then
					pullout.slider:SetThumbTexture([[Interface\AddOns\OctoUI\media\textures\melli]])
		...
		elseif dropdown then
			...
			if dropdown.slider then
				...
				if dropdown.slider:GetThumbTexture() then
					dropdown.slider:SetThumbTexture([[Interface\AddOns\OctoUI\media\textures\melli]])
	...
	RegisterAsWidget = function(self, widget)
		...
		elseif TYPE == "CheckBox" then
			...
			if E.private.skins.checkBoxSkin then
				...
				check:SetTexture([[Interface\AddOns\OctoUI\media\textures\melli]])
		...
		elseif TYPE == "Slider" then
			...
			frame:SetThumbTexture([[Interface\AddOns\OctoUI\media\textures\melli]])
			...
			if widget.treeframe then
				...
				widget.RefreshTree = function(self, scrollToSelection)
					...
					for i = offset + 1, getn(lines) do
						...
						if button then
							button.toggle:SetNormalTexture([[Interface\AddOns\OctoUI\media\textures\PlusMinusButton]])
							button.toggle:SetPushedTexture([[Interface\AddOns\OctoUI\media\textures\PlusMinusButton]])
