...
function AFK:Initialize()
	...
	self.AFKMode.bottom.logo:SetTexture("Interface\\AddOns\\OctoUI\\media\\textures\\logo")

	self.AFKMode.bottom.faction = self.AFKMode.bottom:CreateTexture(nil, "OVERLAY")
	E:Point(self.AFKMode.bottom.faction, "BOTTOMLEFT", self.AFKMode.bottom, "BOTTOMLEFT", -20, -16)
	self.AFKMode.bottom.faction:SetTexture("Interface\\AddOns\\OctoUI\\media\\textures\\"..E.myfaction.."-Logo")
