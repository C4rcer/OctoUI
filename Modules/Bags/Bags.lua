			...
			for slotID = 1, numSlots do
				...
				if not f.Bags[bagID][slotID] then
					...
					if not f.Bags[bagID][slotID].QuestIcon then
						...
						QuestIcon:SetTexture("Interface\\AddOns\\OctoUI\\media\\textures\\bagQuestIcon")
					...
					if not f.Bags[bagID][slotID].JunkIcon then
						...
						JunkIcon:SetTexture("Interface\\AddOns\\OctoUI\\media\\textures\\bagJunkIcon")
...
function B:ContructContainerFrame(name, isBank)
	...
	if isBank then
		...
		f.sortButton:SetNormalTexture("Interface\\AddOns\\OctoUI\\media\\textures\\INV_Pet_Broom")
		f.sortButton:GetNormalTexture():SetTexCoord(unpack(E.TexCoords))
		E:SetInside(f.sortButton:GetNormalTexture())
		f.sortButton:SetPushedTexture("Interface\\AddOns\\OctoUI\\media\\textures\\INV_Pet_Broom")
		f.sortButton:GetPushedTexture():SetTexCoord(unpack(E.TexCoords))
		E:SetInside(f.sortButton:GetPushedTexture())
		f.sortButton:SetDisabledTexture("Interface\\AddOns\\OctoUI\\media\\textures\\INV_Pet_Broom")
		...
		f.editBox.searchIcon:SetTexture("Interface\\AddOns\\OctoUI\\media\\textures\\UI-Searchbox-Icon")
