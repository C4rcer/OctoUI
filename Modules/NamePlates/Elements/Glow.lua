...
function mod:ConstructElement_Glow(frame)
	...
	glow:SetTexture([[Interface\AddOns\OctoUI\media\textures\spark.tga]])
	glow:Hide()
	frame.Glow2 = glow

	local top = frame:CreateTexture(nil, "BACKGROUND")
	top:SetTexture([[Interface\AddOns\OctoUI\media\textures\nameplateTargetIndicator.tga]])
	top:SetWidth(45)
	top:SetHeight(45)
	top:Hide()
	frame.TopArrow = top
	...
	left:SetTexture([[Interface\AddOns\OctoUI\media\textures\nameplateTargetIndicatorLeft.tga]])
	left:SetWidth(45)
	left:SetHeight(45)
	left:Hide()
	...
	right:SetTexture([[Interface\AddOns\OctoUI\media\textures\nameplateTargetIndicatorRight.tga]])
	right:SetWidth(45)
	right:SetHeight(45)
	right:Hide()
