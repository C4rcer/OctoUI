...
GUILD_STATUS = "Statut joueur"
PLAYER_STATUS = "État de la guilde"

--*_ADDON locales
L["INCOMPATIBLE_ADDON"] = "L'addon %s n'est pas compatible avec le module %s d'OctoUI. Merci de sélectionner soit l'addon ou le module d'OctoUI pour le désactiver."

--*_MSG locales
L["LOGIN_MSG"] = "Bienvenue sur %sOctoUI|r version %s%s|r, tapez /ec afin d'accéder au menu de configuration en jeu. Si vous avez besoin d'un support technique, vous pouvez nous rejoindre sur https://github.com/C4rcer/OctoUI/issues"
...
L["ElvUI Installation"] = "Installation d'OctoUI"
L["Finished"] = "Terminé"
...
L["Tank"] = "Tank"
L["The chat windows function the same as Blizzard standard chat windows, you can right click the tabs and drag them around, rename, etc. Please click the button below to setup your chat windows."] = "La fenêtre de chat OctoUI utilise les même fonctions que celle de Blizzard, vous pouvez faire un clique droit sur un onglet pour le déplacer, le renommer, etc."
...
L["This install process will help you learn some of the features in ElvUI has to offer and also prepare your user interface for usage."] = "Ce programme d'installation vous aidera à découvrir quelques fonctionnalités qu'OctoUI offre et préparera également votre interface à son utilisation."
...
L["Trade"] = "Échanger"
L["Welcome to ElvUI version %s!"] = "Bienvenue sur la version %s d'OctoUI!"
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "Vous avez maintenant terminé le processus d'installation. Si vous avez besoin d'un support technique, merci de vous rendre sur https://github.com/C4rcer/OctoUI/issues"
L["You can always change fonts and colors of any element of ElvUI from the in-game configuration."] = "Vous pouvez toujours modifier les polices et les couleurs de n'importe quel élément d'OctoUI dans la configuration du jeu."
...
L["Discard"] = "Annuler"
L["Do you enjoy the new ElvUI?"] = "Aimez-vous le nouveau OctoUI?"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI est périmé d'au moins 5 versions. Vous pouvez télécharger la nouvelle version sur https://github.com/C4rcer/OctoUI"
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI est périmé. Vous pouvez télécharger la nouvelle version sur https://github.com/C4rcer/OctoUI"
L["ElvUI needs to perform database optimizations please be patient."] = "OctoUI a besoin d'effectuer des optimisations de la base de données, merci de patienter."
...
L["Oh lord, you have got ElvUI and Tukui both enabled at the same time. Select an addon to disable."] = "Oh seigneur, vous avez OctoUI et Tukui d'activé en même temps. Sélectionnez un addon à désactiver."
...
L["You have changed your UIScale, however you still have the AutoScale option enabled in ElvUI. Press accept if you would like to disable the Auto Scale option."] = "Vous venez de changer l'échelle de votre interface, alors que votre option d'échelle automatique est encore activée dans OctoUI. Cliquer sur accepter si vous voulez désactiver l'option d'échelle automatique."
...
--Tutorials
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI and setting a keybind for the raid marker."] = "Une fonction marqueur de raid est disponible en appuyant sur Échap -> Raccourcis, défilez en bas d'OctoUI et paramétrez le raccourcis pour le marqueur de raid."
L["ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "OctoUI dispose d'une fonction double spécialisation qui vous permet de charger à la volée des profils différents en fonction de votre spécialisation actuelle."
L["For technical support visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "Pour tout support technique, merci de nous visiter à https://github.com/C4rcer/OctoUI/issues"
L["If you accidently remove a chat frame you can always go the in-game configuration menu, press install, go to the chat portion and reset them."] = "Si vous supprimez accidentellement un cadre de discussion, vous pouvez toujours aller dans le menu de configuration d'OctoUI. Cliquez ensuite sur Installation puis passez à l'étape concernant les fenêtres de discussion pour remettre à zéro les paramètres."
L["If you are experiencing issues with ElvUI try disabling all your addons except ElvUI, remember ElvUI is a full UI replacement addon, you cannot run two addons that do the same thing."] = "Si vous rencontrez des problèmes avec OctoUI, essayez de désactiver tous vos addons sauf OctoUI. Rappelez-vous que'OctoUI est une interface utilisateur complète et que vous ne pouvez pas exécuter deux addons qui font la même chose."
