...
--*_MSG locales
L["LOGIN_MSG"] = "Bienvenido a %sOctoUI|r versión %s%s|r, escribe /ec para acceder al menú de configuración. Si necesitas ayuda o soporte técnico puedes visitarnos en https://github.com/C4rcer/OctoUI/issues"
...
L["ElvUI Installation"] = "Instalación de OctoUI"
...
L["Select the type of aura system you want to use with ElvUI's unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = "Selecciona el tipo de sistema de de auras que deseas utilizar con los marcos de unidad de OctoUI. Establécelo a Barras de Auras e Iconos para usar a la vez la barra de auras y los iconos, establécelo en Sólo Iconos para ver solo los iconos."
...
L["This install process will help you learn some of the features in ElvUI has to offer and also prepare your user interface for usage."] = "El proceso de instalación te ayudará a aprender algunas de las características de OctoUI y preparará la interfaz para su uso."
...
L["Trade"] = "Intercambio"
L["Welcome to ElvUI version %s!"] = "Bienvenido(a) a OctoUI versión %s!"
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "Ya has terminado con el proceso de instalación. Si necesitas ayuda o soporte técnico por favor visítanos en https://github.com/C4rcer/OctoUI/issues"
L["You can always change fonts and colors of any element of ElvUI from the in-game configuration."] = "Siempre puedes cambiar las fuentes y colores de cualquier elemento de OctoUI desde la configuración."
...
--Plugin Installer
L["ElvUI Plugin Installation"] = "Instalación del plugin de OctoUI"
...
L["Discard"] = "Descartar"
L["Do you enjoy the new ElvUI?"] = "¿Disfrutas del nuevo OctoUI?"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI está cinco o mas revisiones desactualizado. Puedes descargar la versión más nueva de https://github.com/C4rcer/OctoUI"
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI está desactualizado. Puedes descargar la versión más nueva de https://github.com/C4rcer/OctoUI"
L["ElvUI needs to perform database optimizations please be patient."] = "OctoUI necesita realizar optimizaciones de base de datos por favor se paciente."
...
L["Oh lord, you have got ElvUI and Tukui both enabled at the same time. Select an addon to disable."] = "Oh cielos, tienes OctoUI y Tukui habilitados al mismo tiempo. Elige un addon a deshabilitar"
...
L["You have changed your UIScale, however you still have the AutoScale option enabled in ElvUI. Press accept if you would like to disable the Auto Scale option."] = "Has cambiado la escala de tu interfaz, sin embargo aún tienes el AutoEscalado activado en OctoUI. Pulsa aceptar si te gustaría desactivar el AutoEscalado."
...
--Tutorials
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI and setting a keybind for the raid marker."] = "La opción de marcador de banda está disponible pulsando Escape -> Asignar teclas -> Recorrer hacia abajo hasta OctoUI y establecer la tecla para el marcador de banda."
L["ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "OctoUI tiene la posibilidad de cargar diferentes perfiles automáticamente al cambiar de especialización de talentos. Puedes activar esta función en la pestaña de perfiles."
L["For technical support visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "Para soporte técnico visítanos en https://github.com/C4rcer/OctoUI/issues"
