...
--*_ADDON locales
L["INCOMPATIBLE_ADDON"] = "Аддон %s не совместим с модулем %s OctoUI. Пожалуйста, выберите отключить ли несовместимый аддон или модуль."

--*_MSG locales
L["LOGIN_MSG"] = "Добро пожаловать в %sOctoUI|r версии %s%s|r, наберите /ec для доступа в меню настроек. Если Вам нужна техническая поддержка, посетите https://github.com/C4rcer/OctoUI/issues"
...
L["Dark"] = "Темная"
L["Disable"] = "Выключить"
L["ElvUI Installation"] = "Установка OctoUI"
...
L["Theme Setup"] = "Тема"
L["This install process will help you learn some of the features in ElvUI has to offer and also prepare your user interface for usage."] = "Этот процесс установки поможет Вам узнать о некоторых функциях OctoUI и подготовить Ваш интерфейс к использованию."
...
L["Trade"] = "Торговля"
L["Welcome to ElvUI version %s!"] = "Добро пожаловать в OctoUI версии %s!"
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "Вы завершили процесс установки. Если Вам требуется техническая поддержка, посетите https://github.com/C4rcer/OctoUI/issues"
L["You can always change fonts and colors of any element of ElvUI from the in-game configuration."] = "Вы всегда можете изменить шрифты и цвета любого элемента OctoUI из меню конфигурации. Классическая и пиксельная темы не отличаются для русского клиента."
...
--Plugin Installer
L["ElvUI Plugin Installation"] = "Установка плагина OctoUI"
...
L["Are you sure you want to apply this font to all ElvUI elements?"] = "Вы уверены, что хоттите применить этот шрифт ко всем элементам OctoUI?"
...
L["Discard"] = "Отменить"
L["Do you enjoy the new ElvUI?"] = "Вам нравится OctoUI?"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "Ваш OctoUI устарел более, чем на 5 версий. Вы можете скачать последнюю версию с https://github.com/C4rcer/OctoUI"
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI устарел. Вы можете скачать последнюю версию с https://github.com/C4rcer/OctoUI"
L["ElvUI needs to perform database optimizations please be patient."] = "OctoUI нужно провести оптимизацию базы данных. Подождите, пожалуйста."
...
L["Oh lord, you have got ElvUI and Tukui both enabled at the same time. Select an addon to disable."] = "Японский городовой... у Вас одновременно включены OctoUI и Tukui. Выберите аддон для отключения."
...
--Tutorials
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI and setting a keybind for the raid marker."] = "Функция рейдовых меток доступна в Escape -> Назначение клавиш. Прокрутите вниз до раздела OctoUI и назначьте клавишу для рейдовых меток."
L["ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "В OctoUI присутствует функция двойной специализации, которая позволит Вам использовать разные профили для разных наборов талантов. Вы можете включить эту функцию в разделе профилей."
L["For technical support visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "За технической поддержкой обращайтесь на https://github.com/C4rcer/OctoUI/issues"
...
L["If you are experiencing issues with ElvUI try disabling all your addons except ElvUI, remember ElvUI is a full UI replacement addon, you cannot run two addons that do the same thing."] = "Если Вы испытываете проблемы с OctoUI, попробуйте отключить все аддоны, кроме самого OctoUI. Помните, OctoUI это аддон, полностью заменяющий интерфейс, Вы не можете одновременно использовать два аддона, выполняющих одинаковые функции."
