...
--*_ADDON locales
L["INCOMPATIBLE_ADDON"] = "Das Addon %s ist nicht mit dem OctoUI %s Modul kompatibel. Bitte deaktiviere entweder das Addon oder deaktiviere das OctoUI Modul."

--*_MSG locales
L["LOGIN_MSG"] = "Willkommen zu %sOctoUI|r Version %s%s|r, Tippe /ec um das Konfigurationsmenü aufzurufen. Für technische Hilfe, besuche das Supportforum unter https://github.com/C4rcer/OctoUI/issues"
...
L["Select the type of aura system you want to use with ElvUI's unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = "Wähle für die OctoUI Einheitenfenster ob das Auren-System Aurenleisten und Symbole, oder nur Symbole anzeigt."
...
L["The in-game configuration menu can be accessed by typing the /ec command or by clicking the 'C' button on the minimap. Press the button below if you wish to skip the installation process."] = "Das OctoUI-Konfigurationsmenü kannst du entweder mit /ec oder durch das Anklicken der 'C' Taste an der Minimap aufrufen. Drücke 'Schritt überspringen' um zum nächsten Schritt zu gelangen."
L["Theme Set"] = "Thema gesetzt"
L["Theme Setup"] = "Thema Setup"
L["This install process will help you learn some of the features in ElvUI has to offer and also prepare your user interface for usage."] = "Dieser Installationsprozess wird dir helfen, die Funktionen von OctoUI für deine Benutzeroberfläche besser kennenzulernen."
...
L["Trade"] = "Handel"
L["Welcome to ElvUI version %s!"] = "Willkommen bei OctoUI Version %s!"
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "Du hast den Installationsprozess abgeschlossen. Solltest du technische Hilfe benötigen, besuche uns auf https://github.com/C4rcer/OctoUI/issues"
...
L["Are you sure you want to apply this font to all ElvUI elements?"] = "Bist du sicher, dass du diese Schrifart auf alle OctoUI Elemente anwenden möchtest?"
...
L["Discard"] = "Verwerfen"
L["Do you enjoy the new ElvUI?"] = "Gefällt dir das neue OctoUI?"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI ist seit fünf oder mehr Revisionen nicht aktuell. Du kannst die neuste Version bei https://github.com/C4rcer/OctoUI herunterladen."
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI ist nicht aktuell. Du kannst die neuste Version bei https://github.com/C4rcer/OctoUI herunterladen."
L["ElvUI needs to perform database optimizations please be patient."] = "OctoUI muss eine Datenbank Optimierung durchführen. Bitte warte eine Moment."
...
L["Oh lord, you have got ElvUI and Tukui both enabled at the same time. Select an addon to disable."] = "Oh Gott, du hast OctoUI und Tukui zur gleichen Zeit aktiviert. Wähle ein Addon um es zu deaktivieren."
...
--Tutorials
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI and setting a keybind for the raid marker."] = "Ein Feature für Schlachtzugsmarkierung ist verfügbar, wenn du Escape drückst und Tastaturbelegung wählst, scrolle anschließend bis unter die Kategorie OctoUI und wähle eine Tastenbelegung für die Schlachtzugsmarkierung."
L["ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "OctoUI hat ein Feature für Dualspezialisierungen, welches dich abhängig von deiner momentanen Spezialisierung verschiedene Profile laden lässt. Dieses Feature kannst du im Abschnitt Profil aktivieren."
L["For technical support visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "Für technische Hilfe besuche uns unter https://github.com/C4rcer/OctoUI/issues"
...
L["If you are experiencing issues with ElvUI try disabling all your addons except ElvUI, remember ElvUI is a full UI replacement addon, you cannot run two addons that do the same thing."] = "Wenn du Probleme mit OctoUI hast, deaktiviere alle Addons außer OctoUI. Denke auch daran, dass OctoUI die komplette Benutzeroberfläche ersetzt, d.h. du kannst kein Addon verwenden, welches die gleichen Funktionen wie OctoUI nutzt."
