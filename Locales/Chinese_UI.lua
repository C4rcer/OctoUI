...
--*_ADDON locales
L["INCOMPATIBLE_ADDON"] = "插件 %s 不相容于 OctoUI 的 %s 模组, 请停用不相容的插件, 或停用模组."

--*_MSG locales
L["LOGIN_MSG"] = "欢迎使用 %sOctoUI|r %s%s|r 版, 请输入/ec进入设定介面. 如需技术支持,请至至 https://github.com/C4rcer/OctoUI/issues"
...
L["Dark"] = "黑暗"
L["Disable"] = "禁用"
L["ElvUI Installation"] = "安装 OctoUI"
L["Finished"] = "完成"
L["Grid Size:"] = "网格尺寸:"
L["Healer"] = "治疗"
...
L["Resolution"] = "分辨率"
L["Select the type of aura system you want to use with ElvUI's unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = "选择你想要在OctoUI的单位框体里使用何种光环系统. 选择光环条和图标将同时使用光环条和图标, 选择图标来仅仅显示图标."
L["Setup Chat"] = "设定聊天框"
L["Setup CVars"] = "设定参数"
L["Skip Process"] = "略过"
...
L["Theme Set"] = "主题设置"
L["Theme Setup"] = "主题安装"
L["This install process will help you learn some of the features in ElvUI has to offer and also prepare your user interface for usage."] = "此安装程序有助你了解 OctoUI 部份功能, 并可协助你预先设定 UI."
...
L["Trade"] = "拾取/交易"
L["Welcome to ElvUI version %s!"] = "欢迎使用 OctoUI 版本 %s!"
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "你已经完成安装过程. 如果你需要技术支持请访问 https://github.com/C4rcer/OctoUI/issues"
L["You can always change fonts and colors of any element of ElvUI from the in-game configuration."] = "你可以在游戏内的设定选项内更改OctoUI的字体、颜色等设定."
...
--Plugin Installer
L["ElvUI Plugin Installation"] = "OctoUI插件安装"
L["In Progress"] = "正在进行中"
...
L["Are you sure you want to apply this font to all ElvUI elements?"] = "确定要对所有OctoUI元素使用这个字体?"
...
L["Discard"] = "取消"
L["Do you enjoy the new ElvUI?"] = "你喜欢新的OctoUI么？"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI已过期5个或者更多的版本。你可以在 https://github.com/C4rcer/OctoUI 下载到最新的版本"
...
L["ElvUI needs to perform database optimizations please be patient."] = "OctoUI需要进行数据库优化, 请耐性等待."
...
L["Oh lord, you have got ElvUI and Tukui both enabled at the same time. Select an addon to disable."] = "你不能同时使用OctoUI和Tukui, 请选择一个禁用."
...
L["You have changed your UIScale, however you still have the AutoScale option enabled in ElvUI. Press accept if you would like to disable the Auto Scale option."] = "你改变了界面缩放比例, 然而OctoUI的自动缩放选项是开启的.点击接受以关闭OctoUI的自动缩放."
...
--Tutorials
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI and setting a keybind for the raid marker."] = "你可以通过按ESC键 -> 按键设置, 滚动到OctoUI设置下方设置一个快速标记的快捷键."
L["ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "OctoUI可以根据你所使用的天赋自动套用不同的设置档. 你可以在配置文件中使用此功能."
L["For technical support visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "如需技术支援请至 https://github.com/C4rcer/OctoUI/issues"
...
L["If you are experiencing issues with ElvUI try disabling all your addons except ElvUI, remember ElvUI is a full UI replacement addon, you cannot run two addons that do the same thing."] = "如果你遇到问题, OctoUI会尝试禁用你除了OctoUI之外的插件. 请记住你不能用不同的插件实现同一功能."
