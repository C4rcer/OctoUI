...
--*_ADDON locales
L["INCOMPATIBLE_ADDON"] = "%s 애드온의 기능이 OctoUI의 %s 모듈과 상충됩니다. 그 애드온을 쓰지 않거나 OctoUI의 기능을 사용해제하세요."

--*_MSG locales
L["LOGIN_MSG"] = "%sOctoUI|r 버전 %s%s|r 을 사용해 주셔서 감사합니다. /ec 를 입력하면 설정창을 열 수 있습니다. 궁금한 점이나 기술지원은 https://github.com/C4rcer/OctoUI/issues 에서 해결하세요"
...
L["%s is attempting to share the profile %s with you. Would you like to accept the request?"] = "%s 유저가 OctoUI 설정을 전송하려 합니다. 받으시겠습니까?"
...
L["Profile download complete from %s, but the profile %s already exists. Change the name or else it will overwrite the existing profile."] = "%s 유저에게서 OctoUI 설정 다운로드가 완료되었습니다. 하지만 건네받은 프로필 이름이 이미 존재합니다. 프로필이름을 바꾸지 않으면 기존의 것에 덮어씌웁니다."
L["Profile download complete from %s, would you like to load the profile %s now?"] = "%s 유저에게서 OctoUI 설정 다운로드가 완료되었습니다. 건네받은 설정을 지금 불러올까요?"
...
L["Dark"] = "어두운 느낌"
L["Disable"] = "비활성화"
L["ElvUI Installation"] = "OctoUI 설치"
L["Finished"] = "마침"
L["Grid Size:"] = "격자 크기 :"
L["Healer"] = "힐러"
...
L["Please click the button below to setup your CVars."] = "OctoUI의 게임 인터페이스 설정을 적용하려면 아래 버튼을 클릭하세요."
...
L["Resolution"] = "해상도"
L["Select the type of aura system you want to use with ElvUI's unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = "OctoUI 유닛프레임에서 표시할 오라(버프,디버프)의 형태를 선택하세요."
L["Setup Chat"] = "대화창 설치"
...
L["Theme Set"] = "테마 적용"
L["Theme Setup"] = "테마 설정"
L["This install process will help you learn some of the features in ElvUI has to offer and also prepare your user interface for usage."] = "이 설치과정을 통해 OctoUI를 좀 더 자신에게 맞게 설정하고|n몇가지 기능에 대해 알 수 있습니다."
...
L["This part of the installation process sets up your World of Warcraft default options it is recommended you should do this step for everything to behave properly."] = "WoW의 기본 인터페이스 설정을 OctoUI에 적합하게 변경합니다. 애드온 사용에 있어 유용하니 적용할 것을 추천합니다."
...
L["Trade"] = "거래"
L["Welcome to ElvUI version %s!"] = "OctoUI 버전 %s에 오신 것을 환영합니다!"
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "설치 과정이 끝났습니다.|n궁금한 점 해결이나 기술지원이 필요하면 |cff2eb7e4https://github.com/C4rcer/OctoUI/issues|r 를 방문하세요."
L["You can always change fonts and colors of any element of ElvUI from the in-game configuration."] = "OctoUI에서 표시하는 폰트나 색상은 설정에서 언제든지 바꿀 수 있습니다."
...
L["Toggle Configuration"] = "OctoUI 설정창 열기"
L["XP:"] = "경험치:"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "현재 사용하는 OctoUI가 5버전 이상 뒤쳐진 버전입니다. https://github.com/C4rcer/OctoUI 에서 새 버전을 다운로드 받으세요."
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI가 오래된 버전입니다. https://github.com/C4rcer/OctoUI 에서 새 버전을 다운로드 받으세요."
L["ElvUI needs to perform database optimizations please be patient."] = "OctoUI의 데이터베이스를 조정할 필요가 있습니다. 잠시 기다려주세요."
...
L["Oh lord, you have got ElvUI and Tukui both enabled at the same time. Select an addon to disable."] = "OctoUI 와 TukUI 를 동시에 사용하려 하고 있습니다. 하나만 선택해 주세요."
...
L["You have changed your UIScale, however you still have the AutoScale option enabled in ElvUI. Press accept if you would like to disable the Auto Scale option."] = "UI 배율이 변경되었지만 OctoUI의 UI크기 자동조절 기능이 켜져있습니다. UI크기 자동조절 기능을 끄고 싶다면 '수락'을 누르세요."
...
--Tutorials
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI and setting a keybind for the raid marker."] = "단축키 설정의 맨 아래에 있는 OctoUI 부분에서 |cff2eb7e4[Raid Marker]|r 기능을 사용하면 대상에게 징표를 간단히 찍을 수 있습니다."
L["ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "각 전문화별로 OctoUI 설정을 따로 지정할 수 있습니다. 설정의 프로필 항목에 |cff2eb7e4[이중 프로필 사용]|r 기능을 확인하세요."
L["For technical support visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "궁금한 사항이나 기술지원은 |cff2eb7e4https://github.com/C4rcer/OctoUI/issues|r에서 해결하세요."
L["If you accidently remove a chat frame you can always go the in-game configuration menu, press install, go to the chat portion and reset them."] = "OctoUI 에서 지원하는 대부분의 기능은 |cff2eb7e4/ec|r 에서 조정이 가능합니다. 하고 싶은 조절 기능이 없다면 직접 lua수정으로 고쳐야 합니다."
L["If you are experiencing issues with ElvUI try disabling all your addons except ElvUI, remember ElvUI is a full UI replacement addon, you cannot run two addons that do the same thing."] = "OctoUI에서 지원하는 기능과 겹치는 다른 애드온을 쓰고 싶으면 OctoUI 설정에서 해당 기능을 사용 체크해제 해야합니다. (예: Bartender, Dominos)"
L["The focus unit can be set by typing /focus when you are targeting the unit you want to focus. It is recommended you make a macro to do this."] = "OctoUI의 특정 기능만 따로 독립애드온으로 분리하는 것은 불가능합니다."
