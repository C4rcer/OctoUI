...
--*_ADDON locales
L["INCOMPATIBLE_ADDON"] = "插件 %s 與 OctoUI 的 %s 模組不相容。請停用不相容的插件，或停用相關的模組."

--*_MSG locales
L["LOGIN_MSG"] = "歡迎使用%sOctoUI |r %s%s|r 版, 請輸入/ec 進入設定介面. 如需技術支援請至 https://github.com/C4rcer/OctoUI/issues"
...
L["Dark"] = "黑暗"
L["Disable"] = "停用"
L["ElvUI Installation"] = "安裝 OctoUI"
L["Finished"] = "設定完畢"
L["Grid Size:"] = "網格尺寸:"
L["Healer"] = "補師"
...
L["Resolution"] = "解析度"
L["Select the type of aura system you want to use with ElvUI's unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = "選擇在 OctoUI 單位框架中要使用的光環系統. 選擇光環條和圖示來同時使用兩者, 選擇圖示來僅使用圖示"
L["Setup Chat"] = "設定對話視窗"
L["Setup CVars"] = "設定參數"
L["Skip Process"] = "略過"
...
L["Theme Set"] = "主題設定"
L["Theme Setup"] = "主題安裝"
L["This install process will help you learn some of the features in ElvUI has to offer and also prepare your user interface for usage."] = "此安裝程序有助你瞭解OctoUI 部份功能, 並可協助你預先設定UI."
...
L["Trade"] = "拾取/交易"
L["Welcome to ElvUI version %s!"] = "歡迎使用 OctoUI %s 版！"
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "已完成安裝程序. 小提示: 若想開啟微型選單, 請在小地圖按滑鼠中鍵. 如果沒有中鍵按鈕, 請按住Shift鍵, 並在小地圖按滑鼠右鍵. 如需技術支援請至 https://github.com/C4rcer/OctoUI/issues"
L["You can always change fonts and colors of any element of ElvUI from the in-game configuration."] = "你可以在遊戲內的設定選項內更改OctoUI的字體、顏色等設定."
...
--Plugin Installer
L["ElvUI Plugin Installation"] = "OctoUI 插件安裝"
L["In Progress"] = "進行中"
...
L["Are you sure you want to apply this font to all ElvUI elements?"] = "你確定要將此字型應用到所有 OctoUI 元素嗎?"
...
L["Discard"] = "取消"
L["Do you enjoy the new ElvUI?"] = "你享受新版的 OctoUI嗎?"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI 以過期超過5個版本. 你可以在 https://github.com/C4rcer/OctoUI 下載到最新的版本."
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-Vanilla/ElvUI/"] = "OctoUI 以過期. 你可以在 https://github.com/C4rcer/OctoUI 下載到最新的版本."
L["ElvUI needs to perform database optimizations please be patient."] = "OctoUI 需要進行資料庫優化, 請稍待."
...
L["Oh lord, you have got ElvUI and Tukui both enabled at the same time. Select an addon to disable."] = "喔 拜託,你不能同時使用 OctoUI 和 Tukui， 請選擇一個停用."
...
L["You have changed your UIScale, however you still have the AutoScale option enabled in ElvUI. Press accept if you would like to disable the Auto Scale option."] = "你改變了介面縮放比例, 然而OctoUI的自動縮放選項是開啟的. 點擊接受以關閉OctoUI的自動縮放."
...
--Tutorials
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI and setting a keybind for the raid marker."] = "你可以通過按ESC鍵-> 按鍵設定, 滾動到OctoUI設定下方設定一個快速標記的快捷鍵."
L["ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "OctoUI 可以根據你所使用的天賦自動套用不同的裝備組. 你可以在設定檔中啟用此功能."
L["For technical support visit us at https://github.com/ElvUI-Vanilla/ElvUI"] = "如需技術支援請至 https://github.com/C4rcer/OctoUI/issues"
...
L["If you are experiencing issues with ElvUI try disabling all your addons except ElvUI, remember ElvUI is a full UI replacement addon, you cannot run two addons that do the same thing."] = "如果你使用 OctoUI 時遇到問題, 請嘗試停用除了OctoUI之外的插件. 請記住 OctoUI 是一套全套的 UI 替換插件, 你不能同時使用不同的插件來完成同一件事."
