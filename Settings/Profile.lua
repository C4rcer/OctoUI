...
P["general"] = {
	...
	--Ported from ShaguTweaks, so a single addon owns these features
	["autoStance"] = true,
	["autoDismount"] = true,
	["energyTick"] = false,
	["combatFeedback"] = true,
...
P["actionbar"] = {
	...
	["barPet"] = {
		...
		--Horizontal. Upstream shipped 1 per row, which stood the bar on its end
		--as a vertical strip against the right edge of the screen.
