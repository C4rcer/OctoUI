		...
		minimap = {
			...
			args = {
				...
				buttonBarGroup = {
					...
					get = function(info) return E.db.general.minimap.buttonBar[ info[getn(info)] ] end,
					set = function(info, value) E.db.general.minimap.buttonBar[ info[getn(info)] ] = value MM:UpdateMinimapButtonBar() end,
					args = {
						header = {
							order = 0,
							type = "header",
						...
						description = {
							order = 1,
							type = "description",
							name = L["Gathers addon buttons off the minimap and lays them out in a row beneath it. Use /moveui to reposition the row."]
						},
						enable = {
							order = 2,
							type = "toggle",
							...
							set = function(info, value)
								E.db.general.minimap.buttonBar.enable = value
						...
						stripBorders = {
							order = 3,
							type = "toggle",
							name = L["Remove Borders"],
							desc = L["Hide the round border and background art some addon buttons draw, leaving just the icon."],
							set = function(info, value)
								E.db.general.minimap.buttonBar.stripBorders = value
								E:StaticPopup_Show("CONFIG_RL")
							end,
							disabled = function() return not E.db.general.minimap.buttonBar.enable end
						},
						buttonsPerRow = {
							order = 4,
							type = "range",
