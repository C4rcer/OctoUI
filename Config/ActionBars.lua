	...
	group["general"] = {
		...
		args = {
			...
			cooldownText = {
				...
				func = function() ACD:SelectGroup(E.ConfigAppName, "general", "cooldown") end
			},
			spacer = {
				order = 3,
				type = "description",
...
E.Options.args.actionbar = {
	...
	args = {
		...
		generalShortcut = {
			...
			name = L["General"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "actionbar", "general") end,
			disabled = function() return not E.ActionBars end
		},
		petBarShortcut = {
			order = 6,
			...
			name = L["Pet Bar"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "actionbar", "barPet") end,
			disabled = function() return not E.ActionBars end
		},
		spacer2 = {
			order = 8,
		...
		stanceBarShortcut = {
			...
			name = L["Stance Bar"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "actionbar", "stanceBar") end,
			disabled = function() return not E.ActionBars end
		},
		microbarShortcut = {
			order = 10,
			...
			name = L["Micro Bar"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "actionbar", "microbar") end,
			disabled = function() return not E.ActionBars end
		},
		bar1Shortcut = {
			order = 11,
			...
			name = L["Bar "]..1,
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "actionbar", "bar1") end,
			disabled = function() return not E.ActionBars end
		},
		spacer3 = {
			order = 12,
		...
		bar2Shortcut = {
			...
			name = L["Bar "]..2,
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "actionbar", "bar2") end,
			disabled = function() return not E.ActionBars end
		},
		bar3Shortcut = {
			order = 14,
			...
			name = L["Bar "]..3,
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "actionbar", "bar3") end,
			disabled = function() return not E.ActionBars end
		},
		bar4Shortcut = {
			order = 15,
			...
			name = L["Bar "]..4,
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "actionbar", "bar4") end,
			disabled = function() return not E.ActionBars end
		},
		spacer4 = {
			order = 16,
		...
		bar5Shortcut = {
			...
			name = L["Bar "]..5,
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "actionbar", "bar5") end,
			disabled = function() return not E.ActionBars end,
		}
	}
}
