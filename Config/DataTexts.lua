...
--Deliberately not called here: it reads DT.RegisteredDataTexts and the live
--panel frames, neither of which exist until the DataTexts module initialises.
--The module calls it itself as datatexts register, and E:BuildDeferredOptions
--calls it once more before the GUI is shown.
