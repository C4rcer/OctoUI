...
L["BAGS_DESC"] = "Ajuster les paramètres des sacs pour OctoUI."
L["CHAT_DESC"] = "Ajuste les paramètres du Chat pour OctoUI."
...
L["ELVUI_DESC"] = "OctoUI est une interface de remplacement complète pour World of Warcraft"
...
L["TOGGLESKIN_DESC"] = "Active ou désactive l'habillage OctoUI des éléments ci-dessous."
...
L["Action button keybinds will respond on key down, rather than on key up"] = "Les boutons d’action associés à un raccourci clavier se déclencheront au moment où la touche est enfoncée, et non relâchée."
...
L["Lock Actionbars"] = "Verr. barres d'actions"
...
L["Select the format of timestamps for chat messages."] = "Sélectionner le format de l'heure dans les fenêtres de discussion."
...
Exemple: Interface\AddOns\OctoUI\media\textures\copy
...
L["Select an additional filter to use. If the selected filter is a whitelist and no other filters are being used (with the exception of Block Non-Personal Auras) then it will block anything not on the whitelist, otherwise it will simply add auras on the whitelist in addition to any other filter settings."] = "Sélectionnez un filtre additionnel à utiliser. Si le filtre sélectionné est une liste blanche et qu'aucun autres filtres sont utilisés (à l'exception du bloc des Auras Non-Personnels) alors il bloquera quoi que ce soit qui n'est pas dans la liste blanche, sinon il suffira d'ajouter les auras dans la liste blanche en plus de tous les autres paramètres des filtres."
