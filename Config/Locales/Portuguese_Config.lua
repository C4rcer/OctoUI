...
L["BAGS_DESC"] = "Ajustar definições das bolsas para a OctoUI."
L["CHAT_DESC"] = "Adjustar definições do bate-papo para o OctoUI."
...
L["ELVUI_DESC"] = "A OctoUI é um Addon completo de substituição da interface original do World of Warcraft."
...
L["Action button keybinds will respond on key down, rather than on key up"] = "As ações dos botões serão executadas quando a tecla for pressionada, em vez de quando for solta."
...
L["LBF Support"] = true
L["Lock Actionbars"] = "Travar barra de ações"
...
L["Pickup Actionkey"] = "Botão de ação de saquear"
...
L["Chat Timestamps"] = "Registro de hora no bate-papo"
...
L["Select the format of timestamps for chat messages."] = "Selecione o formato dos carimbos de hora para mensagens de bate-papo."
...
L["Talents"] = "Talentos"
L["Taxi Frame"] = "Taxi"
L["Time Info"] = "Informações de hora"
...
L["Curse Effect"] = "Efeito de maldição"
...
L["Disease Effect"] = "Efeito de doença"
...
L["Magic Effect"] = "Efeito de magia"
...
L["Poison Effect"] = "Efeito de veneno"
L["Portrait"] = "Retrato"
