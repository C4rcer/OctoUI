...
L["BAGS_DESC"] = "調整 OctoUI 背包設定."
L["CHAT_DESC"] = "對話框架設定."
L["COOLDOWN_DESC"] = "調整冷卻設定."
L["DATATEXT_DESC"] = "螢幕資訊文字顯示設定."
L["DATABAR_DESC"] = "設置各種數據條"
L["ELVUI_DESC"] = "OctoUI 為一套功能完整，可用來替換 WOW 原始介面的 UI 套件"
...
L["ActionBars"] = "快捷列"
L["Action button keybinds will respond on key down, rather than on key up"] = "快捷鍵按鍵設定會在按下按鍵時生效，而不是在鬆開按鍵的時候。"
...
L["Select the format of timestamps for chat messages."] = "選擇在對話訊息中時間標記的格式。"
...
範例：Interface\AddOns\OctoUI\media\textures\copy
...
L["The unit prefixes you want to use when values are shortened in ElvUI. This is mostly used on UnitFrames."] = "在OctoUI中數值單位的縮寫. 該選項主要應用在單位框體."
L["Thin Border Theme"] = "細邊框主題"
L["This is for Customized Icons in your Interface/Icons folder."] = true
L["This selects the Chat Frame to use as the output of ElvUI messages."] = "選擇OctoUI訊息輸出的聊天視窗"
...
--Media
L["Applies the font and font size settings throughout the entire user interface. Note: Some font size settings will be skipped due to them having a smaller font size by default."] = "把該字體設置應用到所有OctoUI設置中去,但是某些設置並不會被改變."
...
L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI config. NOTE: Any font that inherits from the fonts ElvUI usually replaces will be affected as well if you disable this. Enabled by default."] = "用OctoUI字體設置代替暴雪原有字體設置,如果禁用有可能導致你的UI出問題,默認開啟開選項."
...
L["Core |cff00b30bE|r|cffC4C4C4lvUI|r options."] = "核心 |cff00b30bE|r|cffC4C4C4lvUI|r 選項"
