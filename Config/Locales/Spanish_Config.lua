...
L["BAGS_DESC"] = "Ajusta las opciones de las bolsas para OctoUI."
L["CHAT_DESC"] = "Configura los ajustes del chat para OctoUI."
...
L["ELVUI_DESC"] = "OctoUI es un addon que reemplaza la interfaz completa de World of Warcraft."
...
L["Action button keybinds will respond on key down, rather than on key up"] = "Los atajos de los botones de acción responderán al pulsar una tecla y no al soltarla."
...
L["LBF Support"] = true
L["Lock Actionbars"] = "Bloquear barras de acción"
...
L["Select the format of timestamps for chat messages."] = "Selecciona el formato del tiempo de los mensajes de chat."
...
Ejemplo: Interface\AddOns\OctoUI\media\textures\copy
...
L["Show an incomming heal prediction bar on the unitframe. Also display a slightly different colored bar for incoming overheals."] = "Muestra una barra de predicción de sanación en el marco de unidad. También muestra una barra ligeramente coloreada para sobresanaciones recibidas."
