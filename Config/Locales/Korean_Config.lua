...
L["ELVUI_DESC"] = "OctoUI는 WoW에서 지원하는 대부분의 기능을 대체하는 통합 애드온입니다."
...
|cff2eb7e4< 예시 >|r
|cffceff00Interface/AddOns/OctoUI/media/textures/|cff2eb7e4TestImage|r
...
L["Enable/Disable the loot roll frame."] = "OctoUI 디자인의 입찰 / 차비 / 마력추출을 선택하는 주사위 굴림창 사용 여부를 결정합니다."
...
L["Reset all frames to their original positions."] = "OctoUI 에서 움직일 수 있는 모든 프레임의 위치를 기본 위치로 초기화합니다."
...
L["The unit prefixes you want to use when values are shortened in ElvUI. This is mostly used on UnitFrames."] = "OctoUI에서 수치를 짧게 표시하고 싶을때 단위를 사용해 축약합니다. 주로 유닛프레임에서 사용됩니다."
L["Thin Border Theme"] = "얇은 경계 테마"
L["This is for Customized Icons in your Interface/Icons folder."] = true
L["This selects the Chat Frame to use as the output of ElvUI messages."] = "This selects the Chat Frame to use as the output of OctoUI messages."
...
L["Backdrop color of transparent frames"] = "OctoUI에서 생성하는 모든 반투명한 프레임의 배경 색상과 투명도를 결정합니다."
...
L["Fonts"] = "글꼴"
L["Main backdrop color of the UI."] = "OctoUI에서 생성하는 모든 불투명한 프레임의 배경 색상을 결정합니다."
...
L["Set the font size for everything in UI. Note: This doesn't effect somethings that have their own seperate options (UnitFrame Font, Datatext Font, ect..)"] = "OctoUI에서 쓰이는 모든 글꼴 크기를 결정합니다.|n|n개인적으로 글꼴 크기를 지정할 수 있는 곳은 적용되지 않습니다."
L["Textures"] = "텍스처"
...
L["The font that the core of the UI will use."] = "OctoUI에서 쓰이는 모든 글자의 글꼴을 결정합니다.|n|n개인적으로 글꼴을 지정할 수 있는 곳은 적용되지 않습니다."
...
L["Install"] = "설치"
L["Run the installation process."] = "OctoUI의 설치 프로세스를 실행합니다."
L["Toggle Anchors"] = "프레임 이동 모드"
L["Unlock various elements of the UI to be repositioned."] = "OctoUI에서 위치를 조정할 수 있는 프레임들을 움직이는 이동 모드를 실행합니다."
L["Version"] = "버전"
