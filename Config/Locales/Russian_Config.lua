...
L["BAGS_DESC"] = "Настройки сумок OctoUI"
L["CHAT_DESC"] = "Настройте отображение чата OctoUI."
...
L["ELVUI_DESC"] = "OctoUI это аддон для полной замены пользовательского интерфейса World of Warcraft."
...
L["Lock Actionbars"] = "Закрепить панели команд"
...
Пример: Interface\AddOns\OctoUI\media\textures\copy
...
L["Enable/Disable the loot frame."] = "Включить/выключить окно добычи OctoUI."
L["Enable/Disable the loot roll frame."] = "Включить/выключить фрейм распределения добычи OctoUI."
...
L["The unit prefixes you want to use when values are shortened in ElvUI. This is mostly used on UnitFrames."] = "Сокращения для значений, показываемых OctoUI. В большинстве своем используются для рамок юнитов."
...
L["This selects the Chat Frame to use as the output of ElvUI messages."] = "В какой чат отправлять сообщения от OctoUI."
...
L["Core |cff00b30bE|r|cffC4C4C4lvUI|r options."] = "Основные опции |cff00b30bE|r|cffC4C4C4lvUI|r"
