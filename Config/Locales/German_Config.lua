...
L["CHAT_DESC"] = "Anpassen der Chateinstellungen für OctoUI."
...
L["ELVUI_DESC"] = "OctoUI ist ein komplettes Benutzerinterface für World of Warcraft."
...
L["Action button keybinds will respond on key down, rather than on key up"] = "Keybinds werden bei Herunterdrücken der Taste ausgelöst, nicht beim Loslassen"
...
L["The first button anchors itself to this point on the bar."] = "Die erste Aktionstaste dockt an diesen Punkt in der Leiste an."
...
L["Threshold before text turns red and is in decimal form. Set to -1 for it to never turn red"] = "Schwellenwert bevor der Text rot wird. Setze diesen Wert auf -1, wenn er nie rot werden soll"
L["Toggles the display of the actionbars backdrop."] = "Aktiviere den Hintergrund der Aktionsleisten."
L["Transparency level when not in combat, no target exists, full health, not casting, and no focus target exists."] = "Transparenzlevel wenn nicht im Kampf, kein Ziel ausgewählt, volle Gesundheit, nicht am Zaubern und kein Fokus existiert."
L["Usable"] = "Nutzbar"
...
L["Require holding the Alt key down to move cursor or cycle through messages in the editbox."] = "Erfordert dass Drücken der Alt-Taste, um mit den Mauszeiger durch die Nachrichten zu scrollen."
...
L["Set the font outline."] = "Setzt die Schrift-Kontur." --Also used in UnitFrames section
...
Or for most users it would be easier to simply put a tga file into your WoW folder, then type the name of the file here.]] ] = [[Gib einen Dateinamen im World of Warcraft Verzeichnis an. Texturen-Ordner, den du als Fensterhintergrund eingestellt haben willst.
...
Zum Beispiel: Interface\AddOns\OctoUI\media\textures\copy
...
L["Automatically scale the User Interface based on your screen resolution"] = "Automatische Skalierung des Interfaces, angepasst an deine Bildschirmauflösung"
...
L["Change Language"] = "Sprache wechseln"
L["Change the ElvUI option to a different language."] = "Ändert die OctoUI Optionen in eine andere Sprache."
...
L["The unit prefixes you want to use when values are shortened in ElvUI. This is mostly used on UnitFrames."] = "Der Einheitenpräfix den du benutzen möchtest wenn die Werte von OctoUI verkürzt sind. Wird meist auf den Einheitenfenstern benutzt."
...
L["This selects the Chat Frame to use as the output of ElvUI messages."] = "Dieses wählt das Chatfenster aus wo die OctoUI Nachrichten erscheinen sollen."
...
L["Applies the primary texture to all statusbars."] = "Wendet die primäre Textur auf alle Statusleisten an."
...
L["Textures"] = "Texturen"
L["The font that combat text will use. |cffFF0000WARNING: This requires a game restart or re-log for this change to take effect.|r"] = "Die Schriftart des Kampftextes. |cffFF0000WARNUNG: Diese Änderung erfordert einen Neustart des Spiels oder einen Relog.|r"
...
L["Core |cff00b30bE|r|cffC4C4C4lvUI|r options."] = "|cff00b30bE|r|cffC4C4C4lvUI|r Einstellungen"
...
L["Cutaway Health"] = "Animiertes Leben"
L["Damage"] = "Schaden"
...
L["Arena Frame"] = "Arenafenster"
L["Arena Registrar"] = "Arena-Anmelder"
...
L["Color castbars by the reaction type of non-player units."] = "Färbe die Zauberleiste entsprechend der Reaktionsart der Einheit."
...
L["Delete a created filter, you cannot delete pre-existing filters, only custom ones."] = "Entferne einen erstellten Filter. Es können nur benutzerdefinierte Filter entfernt werden, keine voreinstellten."
...
L["Disease Effect"] = "Krankheitseffekt"
...
L["Focus"] = "Fokus"
L["Force Off"] = "Forciert aus"
L["Force On"] = "Forciert an"
L["Force Reaction Color"] = "Forciere Reaktionsfarbe"
L["Force the frames to show, they will act as if they are the player frame."] = "Forciere die Fenster sichtbar zu werden. Diese Fenster werden sich wie das Spielerfenster verhalten."
L["Forces Debuff Highlight to be disabled for these frames"] = "Forciere die Deaktivierung der Schwächungszauber-Hervorhebung für diese Fenster"
...
L["Offset position for text."] = "Positionsversatz für Texte."
L["Offset"] = "Versatz"
...
L["Set the filter type. Blacklist will hide any auras in the list and show all others. Whitelist will show any auras in the filter and hide all others."] = "Wähle den Filtertyp. 'Schwarze Liste' versteckt alle Auren in der Liste und zeigt den Rest an. 'Weiße Liste' zeigt alle Auren in der Liste an und versteckt den Rest."
...
L["Sets the font instance's horizontal text alignment style."] = "Wähle den horiziontalen Textausrichtungs-Stil der Schriftart-Instanz."
...
L["Text Threshold"] = "Text-Schwellenwert"
...
L["This dictates the size of the icon when it is not attached to the castbar."] = "Dieses schreibt die Größe des Symbols vor, wenn es nicht an der Zauberleiste angehängt ist."
...
L["Threat Display Mode"] = "Bedrohungsanzeige-Modus"
...
L["Use the profile specific filter 'Buff Indicator (Profile)' instead of the global filter 'Buff Indicator'."] = "Benutze den profilspezifischen 'Buff Indikator (Profil)' anstatt des globalen Filters 'Buff Indikator'."
L["Use thin borders on certain unitframe elements."] = "Benutze dünne Rahmen auf bestimmten Einheitenfenster-Elementen."
L["Use this backdrop color for units that are dead or ghosts."] = "Benutze diese Hintergrundfarbe für Einheiten, die tot oder Geist sind."
