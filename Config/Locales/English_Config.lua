...
L["BAGS_DESC"] = "Adjust bag settings for OctoUI."
L["CHAT_DESC"] = "Adjust chat settings for OctoUI."
...
L["ELVUI_DESC"] = "OctoUI is a complete User Interface replacement addon for OctoWoW, based on the ElvUI 1.12.1 backport."
...
L["The unit prefixes you want to use when values are shortened in ElvUI. This is mostly used on UnitFrames."] = "The unit prefixes you want to use when values are shortened in OctoUI. This is mostly used on UnitFrames."
...
L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI config. NOTE: Any font that inherits from the fonts ElvUI usually replaces will be affected as well if you disable this. Enabled by default."] = "Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the OctoUI config. NOTE: Any font that inherits from the fonts OctoUI usually replaces will be affected as well if you disable this. Enabled by default."
