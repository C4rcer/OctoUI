	...
	local config = {
		...
		args = {
			...
			configureButton = {
				...
				func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "generalOptionsGroup", "allColorsGroup", "healthGroup") end
			},
			bgUseBarTexture = {
				order = 7,
				type = "toggle",
	...
	local config = {
		...
		args = {
			...
			configureButton = {
				...
				name = L["Coloring"],
				desc = L["This opens the UnitFrames Color settings. These settings affect all unitframes."],
				func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "general", "allColorsGroup", "powerGroup") end
			},
			position = {
				order = 7,
				type = "select",
	...
	local config = {
		...
		args = {
			...
			configureButton = {
				...
				name = L["Coloring"],
				desc = L["This opens the UnitFrames Color settings. These settings affect all unitframes."],
				func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "generalOptionsGroup", "allColorsGroup", "castBars") end,
			},
			enable = {
				order = 5,
				type = "toggle",
...
E.Options.args.unitframe = {
	...
	args = {
		...
		generalShortcut = {
			...
			name = L["General"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "generalOptionsGroup", "generalGroup") end,
		...
		frameGlowShortcut = {
			...
			name = L["Frame Glow"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "generalOptionsGroup", "frameGlowGroup") end,
			disabled = function() return not E.UnitFrames end
		},
		cooldownShortcut = {
			order = 7,
			...
			name = L["Cooldowns"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "cooldown", "unitframe") end,
			disabled = function() return not E.UnitFrames end
		},
		spacer2 = {
			order = 8,
		...
		colorsShortcut = {
			...
			name = L["Colors"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "generalOptionsGroup", "allColorsGroup") end,
			disabled = function() return not E.UnitFrames end
		},
		blizzardShortcut = {
			order = 10,
			...
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "generalOptionsGroup", "disabledBlizzardFrames") end,
			disabled = function() return not E.UnitFrames end
		},
		playerShortcut = {
			order = 11,
			...
			name = L["Player Frame"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "player") end,
			disabled = function() return not E.UnitFrames end
		},
		spacer3 = {
			order = 12,
		...
		targetShortcut = {
			...
			name = L["Target Frame"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "target") end,
			disabled = function() return not E.UnitFrames end
		},
		targettargetShortcut = {
			...
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "targettarget") end,
			disabled = function() return not E.UnitFrames end
		},
		targettargettargetShortcut = {
			...
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "targettargettarget") end,
			disabled = function() return not E.UnitFrames end
		},
		spacer4 = {
			order = 16,
		...
		petShortcut = {
			...
			name = L["Pet Frame"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "pet") end,
			disabled = function() return not E.UnitFrames end
		},
		spacer5 = {
			order = 18,
		...
		pettargetShortcut = {
			...
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "pettarget") end,
			disabled = function() return not E.UnitFrames end
		},
		partyShortcut = {
			order = 20,
			...
			name = L["Party Frames"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "party") end,
			disabled = function() return not E.UnitFrames end
		},
		raidShortcut = {
			order = 21,
			...
			name = L["Raid Frames"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "raid") end,
			disabled = function() return not E.UnitFrames end
		},
		spacer6 = {
			order = 22,
		...
		raid40Shortcut = {
			...
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "raid40") end,
			disabled = function() return not E.UnitFrames end
		},
		raidpetShortcut = {
			order = 24,
			...
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "unitframe", "raidpet") end,
			disabled = function() return not E.UnitFrames end
		},
		spacer7 = {
			order = 25,
...
--Deliberately not called here. It walks E.db.unitframe.units, and E.db does not
--exist until AddOn:OnInitialize, which fires after every file in the TOC has
--run. E:BuildDeferredOptions calls it on the first /ec instead.
