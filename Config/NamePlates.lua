...
local function GetUnitSettings(unit, name)
	local copyValues = {}
	--P (profile defaults), not NP.db: this function is called at file scope when
	--the options table is built, and NP.db is not assigned until NP:Initialize
	--at PLAYER_LOGIN. Only the unit KEYS are wanted here, and those are fixed,
	--so the defaults give the same list.
	for x, y in pairs(P.nameplates.units) do
			...
			buffsGroup = {
				...
				args = {
					...
					filtersGroup = {
						...
						type = "group",
						guiInline = true,
						--Personal Auras and Maximum Duration are gone: 1.12 reports neither
						--the caster nor the duration of another unit's auras
						args = {
							filter = {
								order = 1,
								type = "select",
...
E.Options.args.nameplate = {
	...
	args = {
		...
		generalShortcut = {
			...
			name = L["General"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "nameplate", "generalGroup", "general") end,
		...
		fontsShortcut = {
			...
			name = L["Fonts"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "nameplate", "generalGroup", "fontGroup") end,
			disabled = function() return not E.NamePlates; end,
		},
		spacer2 = {
			order = 7,
		...
		friendlyPlayerShortcut = {
			...
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "nameplate", "friendlyPlayerGroup") end,
			disabled = function() return not E.NamePlates; end,
		},
		enemyPlayerShortcut = {
			order = 9,
			...
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "nameplate", "enemyPlayerGroup") end,
			disabled = function() return not E.NamePlates; end,
		},
		spacer5 = {
			order = 10,
		...
		friendlyNPCShortcut = {
			...
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "nameplate", "friendlyNPCGroup") end,
			disabled = function() return not E.NamePlates; end,
		},
		enemyNPCShortcut = {
			order = 12,
			...
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "nameplate", "enemyNPCGroup") end,
			disabled = function() return not E.NamePlates; end,
		},
--[[		filtersShortcut = {
			order = 13,
			...
			name = L["Style Filter"],
			buttonElvUI = true,
			func = function() ACD:SelectGroup(E.ConfigAppName, "nameplate", "filters") end,
			disabled = function() return not E.NamePlates; end,
		},]]
		generalGroup = {
			order = 14,
