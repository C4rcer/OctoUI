...
function E:UpdateBlizzardFonts()
	...
	if self.eyefinity then
		...
		-- These panels are retail-era names and are absent on this client, so the
		-- CVars below carry the change on their own.
		if InterfaceOptionsCombatTextPanelTargetDamage then
		...
		local INVISIBLE = [[Interface\Addons\OctoUI\media\fonts\Invisible.ttf]]
		COMBAT = INVISIBLE
	end
