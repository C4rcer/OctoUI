...
function E:ToggleConfigMode(override, configType)
	...
	if E.ConfigurationMode ~= true then
		...
		if E.ConfigLoaded then
			LibStub("AceConfigDialog-3.0"):Close(E.ConfigAppName)
			GameTooltip:Hide()
		end
...
function E:CreateMoverPopup()
	...
	lock:SetScript("OnClick", function()
		...
		if E.ConfigLoaded then
			LibStub("AceConfigDialog-3.0"):Open(E.ConfigAppName)
		end
	...
	upButton.icon:SetTexture([[Interface\AddOns\OctoUI\media\textures\SquareButtonTextures]])
	...
	downButton.icon:SetTexture([[Interface\AddOns\OctoUI\media\textures\SquareButtonTextures]])
	...
	leftButton.icon:SetTexture([[Interface\AddOns\OctoUI\media\textures\SquareButtonTextures]])
	...
	rightButton.icon:SetTexture([[Interface\AddOns\OctoUI\media\textures\SquareButtonTextures]])
