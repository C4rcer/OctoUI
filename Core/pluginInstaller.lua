...
function PI:CreateFrame()
	...
	f.pending.tex:SetTexture([[Interface\AddOns\OctoUI\media\textures\UI-OptionsFrame-NewFeatureIcon]])
...
function PI:RunInstall()
	...
	if self.Installs[1] and not PluginInstallFrame:IsShown() and not (_G["ElvUIInstallFrame"] and _G["ElvUIInstallFrame"]:IsShown()) then
		...
		f.tutorialImage:SetTexture(db.tutorialImage or [[Interface\AddOns\OctoUI\media\textures\logo]])
